...
export function CronJobSortDialog({
  ...
  return (
    <ModalOverlay
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="cron-job-sort-dialog-title"
      data-testid="cron-job-sort-dialog"
      ...
      <div className={cn(
        ...
        <div className="relative shrink-0 px-6 pt-6 pb-3">
          ...
          <Button
            ...
            onClick={handleClose}
            disabled={saving}
            data-testid="cron-job-sort-close"
          >
            <X className="h-4 w-4" />
          </Button>
        </div>
            ...
            {draftOrder.map((id) => {
              ...
              return (
                <div
                  key={id}
                  draggable={!saving}
                  data-testid={`cron-job-sort-item-${id}`}
                  onDragStart={(event) => {
                    if (saving) {
                      event.preventDefault();
                      return;
        ...
        <div className="shrink-0 flex items-center justify-end gap-2 border-t border-black/5 px-6 py-4 dark:border-white/10">
          <Button
            ...
            onClick={handleClose}
            disabled={saving}
            data-testid="cron-job-sort-cancel"
          ...
          <Button
            ...
            disabled={saving}
            data-testid="cron-job-sort-confirm"
