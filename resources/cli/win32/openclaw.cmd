...
if /i "%1"=="update" (
    echo openclaw is managed by LYClaw ^(bundled version^).
    echo.
    echo To update openclaw, update LYClaw:
    echo   Open LYClaw ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=LYClaw
