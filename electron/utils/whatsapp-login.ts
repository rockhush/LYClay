...
// contains LYClaw's own devDependencies — packages that are NOT deps of openclaw
...
function resolveOpenClawPackageJson(packageName: string): string {
    ...
    // 2. Fallback to project-level deps (works in dev mode for LYClaw devDependencies)
    try {
